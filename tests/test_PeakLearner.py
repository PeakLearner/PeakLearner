...
class PeakLearnerTests(Base.PeakLearnerTestBase):
    ...
    def test_modelTooLow(self):
        modelQueryUrl = '/Public/H3K4me3_TDH_ENCODE/thyroid_ENCFF014AIG/models?ref=chr17&start=40413200&end=40697800&width=250&scale=0.01&visibleStart=40492400&visibleEnd=40634700&modelType=FLOPART&toString=function%20()%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20return%20chunk.ref%20%2B%20%27%2C%27%20%2B%20chunk.start%20%2B%20%27%2C%27%20%2B%20chunk.end%20%2B%20%27%2C%27%20%2B%20this.cacheKey%3B%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%7D&name=thyroid_ENCFF014AIG'
        output = self.testapp.get(modelQueryUrl)
        ...
        thyroidLabelURL = '/Public/H3K4me3_TDH_ENCODE/thyroid_ENCFF014AIG/labels'

        for label in testLabels:
            request = self.testapp.put(thyroidLabelURL, json=label)
